...
def main(args = None):
    ...
    #     #Further splitting the training data into training and validation sets allows for model performance monitoring during training. Preprocessing the data into a format suitable for the CNN is necessary for effective model training.
    #     #Further splits the training set into training and validation sets. Counts vocabulary in the training data and initializes word vectors using wv_initialize.
    ...
    top_model = load_model('/gs_icd_label_pretrained.h5')
    fold_actual = test_y
